...
Source: `Propfirm Trading Dashboard/goldtest/gold_results_phase28_before.json`
Generated at (goldtest run): 2026-05-24T17:13:25.479496
Total cases: 160
...
| Outcome | Count | Pct |
|---|---|---|
| STAGE1_MATCH | 94 | 58.8% |
| STAGE1_NEUTRAL | 30 | 18.8% |
...
| equity_indices (44) | 21 (60%) | 7 | 7 | 7 | 2 |
...
|---|---|---|---|
| cot_strength | 0 | 30 | 30 |
| constituent | 1 | 28 | 29 |
| seasonality | 15 | 13 | 28 |
| cot | 4 | 23 | 27 |
| valuation | 6 | 19 | 25 |
| trend | 9 | 11 | 20 |
| location | 11 | 9 | 20 |
...
### equity_indices
- cot_strength:neutral: 7
- valuation:neutral: 7
- location:neutral: 5
- constituent:neutral: 5
- seasonality:opposing: 4
- cot:neutral: 3
- trend:neutral: 3
- cot:opposing: 2
- trend:opposing: 2
...
- Case  84 NQ=F     2023-11-03 [weekly] Bernd=bullish Sys=neutral
   Components: location=bearish, trend=downtrend, cot=bearish, cot_strength=strong, valuation=neutral, seasonality=bullish, constituent=neutral
   Disagreeing with Bernd (bullish): location(opposing), trend(opposing), cot(opposing), cot_strength(neutral), valuation(neutral), constituent(neutral)
   Reasoning: Undervalued long-term, 10/30-period seasonal low, weekly demand 180 points away.
   ... and 2 more
